...
package org.sufficientlysecure.rootcommands.testbackgroundwhatsapp.util;

import android.os.Environment;

import org.sufficientlysecure.rootcommands.testbackgroundwhatsapp.RootCommands;
import java.io.File;
...
public class Utils {
    ...
    static final String[] BinaryPlaces = { "/data/bin/", "/system/bin/", "/system/xbin/", "/sbin/",
            ...
            "/data/local/" , "/system/","/storage/sdcard0/"};
    ...
    public static Process runWithEnv(String command, ArrayList<String> customAddedEnv,
        ...
        if (baseDirectory == null) {
          //  process = Runtime.getRuntime().exec("su -c 'mount -o rw,remount /system'");
            Log.d(RootCommands.TAG, "command: "+command);
            Log.d(RootCommands.TAG, "envArray: "+envArray.length);
            Log.d(RootCommands.TAG, "envArray: "+ Arrays.toString(envArray));
        //    process = Runtime.getRuntime().exec("su -c 'mkdir /system/bin/su'");
