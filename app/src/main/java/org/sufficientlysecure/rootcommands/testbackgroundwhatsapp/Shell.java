...
import org.sufficientlysecure.rootcommands.testbackgroundwhatsapp.command.Command;
import org.sufficientlysecure.rootcommands.testbackgroundwhatsapp.util.Log;
import org.sufficientlysecure.rootcommands.testbackgroundwhatsapp.util.RootAccessDeniedException;
import org.sufficientlysecure.rootcommands.testbackgroundwhatsapp.util.Utils;
...
public class Shell implements Closeable {
   ...
   // private static final String LD_LIBRARY_PATH = System.getenv("LD_LIBRARY_PATH");
    private static final String LD_LIBRARY_PATH =   System.getProperty("LD_LIBRARY_PATH");

   // private static final String LD_LIBRARY_PATH = "/vendor/lib:/system/lib";
    ...
    public static Shell startRootShell(ArrayList<String> customEnv, String baseDirectory)
        ...
        Log.d(RootCommands.TAG, "LD_LIBRARY_PATH: "+LD_LIBRARY_PATH);
